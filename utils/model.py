...
from models import resnet, pre_act_resnet, wide_resnet, resnext, densenet,T3D


def generate_model(opt):
    assert opt.model in [
        'resnet', 'preresnet', 'wideresnet', 'resnext', 'densenet','C3D','T3D'
    ]
    ...
    if opt.model == 'resnet':
        ...
        from models.T3D import get_fine_tuning_parameters
