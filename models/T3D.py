...
import math
from models.TTL import TemporalTransimitionLayer

__all__ = [
    'DenseNet', 'T3D121', 'T3D169', 'T3D201', 'T3D264'
]
...
class _Transition(nn.Sequential):
    ...
    def __init__(self, num_input_features, num_output_features, depths):
        super(_Transition, self).__init__()
        self.add_module('TTL',TemporalTransimitionLayer(num_input_features,num_output_features,depths=depths))
    ...
    def __init__(self,
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                ...
                trans = _Transition(
                    num_input_features=num_features,
                    num_output_features=num_features // 2, depths=_depth)
